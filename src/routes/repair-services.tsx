...
function BeforeAfter({ label, path, accent }: { label: string; path: string | null; accent?: boolean }) {
  return (
    <div className="relative aspect-[4/3] bg-secondary flex items-center justify-center p-2 sm:p-3">
      <SignedImage path={path} className="h-[94%] w-[94%] object-contain" alt={label} />
