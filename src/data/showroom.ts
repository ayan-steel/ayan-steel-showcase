...
export const CONTACT = {
  ...
  phone: "+91 9709622371",
  altPhone: "+91 6200427779",
  phoneRaw: "+919709622371",
  altPhoneRaw: "+916200427779",
  whatsapp: "919709622371",
...
export const PRODUCTS: Product[] = [
  { id: "steel-almirah-pro", name: "Heritage Steel Almirah", brand: "Ayan Steel Originals", category: "Steel Almirah", price: 18900, salePrice: 15499, image: almirah, badge: "Best Seller", description: "Four-door brushed steel almirah with locker compartment and powder-coat finish." },
  { id: "executive-leather", name: "Onyx Executive Chair", brand: "Featherlite", category: "Executive Chair", price: 22500, salePrice: 17999, image: chair, badge: "New", description: "Top-grain leather, polished aluminium base, multi-tilt mechanism." },
  { id: "walnut-dining-6", name: "Walnut Six-Seater Dining", brand: "Durian", category: "Dining Table", price: 64000, salePrice: 52900, image: dining, badge: "Featured", description: "Solid walnut top with hand-finished chairs. Seats six comfortably." },
  { id: "linen-lounge-sofa", name: "Linen Lounge 3-Seater", brand: "HOF", category: "Sofa", price: 48900, salePrice: 39900, image: sofa, description: "Boucle linen upholstery on a solid walnut frame with dense foam seats." },
  { id: "atelier-study-desk", name: "Atelier Study Desk", brand: "Ayan Steel Originals", category: "Study Table", price: 14900, salePrice: 11900, image: table, badge: "New", description: "Sheesham wood desk with twin drawers and cable management." },
  { id: "library-bookshelf", name: "Library Bookshelf", brand: "Godrej Interio", category: "Bookshelf", price: 26500, image: bookshelf, description: "Floor-to-ceiling walnut bookshelf with adjustable shelves." },
];
